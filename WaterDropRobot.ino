...
// EPROM addresses
const int SCHEDULE_EEPROM_ADDR = WTR_LEVEL_ADDR + STORAGE_SIZE_WATER_LEVEL;
...
// Keyboard controls
const uint8_t PIN_KEYS[] = { 2, 3 };
KeyboardWithISR keyboard(PIN_KEYS);

// Display class
RobotDisplay display(lcd, rtc, waterLevelMeter, waterOutValve, waterInValve);
